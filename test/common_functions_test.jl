...
@testset "symplectic_min_supports" begin
    ...
    test_support_jacobian = vcat(
        [
            ...
            x(1, 2) * y(1, 2) * x(1, 2)^(-1) * y(1, 2),
            x(1, 2) * y(1, 2) * x(1, 2)^(-1) * y(1, 2)^(-1) * z(1)^(-1),
            x(1, 2) * y(1, 2) * x(1, 2)^(-1) * y(1, 2)^(-1) * z(1),
            x(1, 2) * y(1, 2) * x(1, 2)^(-1) * y(1, 2)^(-1) * z(1)^(-1) * z(1)^(-1),
            x(1, 2) * y(1, 2) * x(1, 2)^(-1) * y(1, 2)^(-1) * z(1)^(-1) * z(1),
        ],
        [
            x(1, 2),
            x(1, 2)^(-1),
            ...
            x(1, 2) * yt(1, 2) * x(1, 2)^(-1) * yt(1, 2),
            x(1, 2) * yt(1, 2) * x(1, 2)^(-1) * yt(1, 2)^(-1) * zt(2),
            x(1, 2) * yt(1, 2) * x(1, 2)^(-1) * yt(1, 2)^(-1) * zt(2)^(-1),
            x(1, 2) * yt(1, 2) * x(1, 2)^(-1) * yt(1, 2)^(-1) * zt(2) * zt(2),
            x(1, 2) * yt(1, 2) * x(1, 2)^(-1) * yt(1, 2)^(-1) * zt(2) * zt(2)^(-1),
        ],
        [
            x(1, 2),
            x(1, 2)^(-1),
            ...
            x(1, 2) * z(2) * x(1, 2)^(-1) * z(2),
            x(1, 2) * z(2) * x(1, 2)^(-1) * z(2)^(-1) * z(1)^(-1),
            x(1, 2) * z(2) * x(1, 2)^(-1) * z(2)^(-1) * z(1),
            x(1, 2) * z(2) * x(1, 2)^(-1) * z(2)^(-1) * z(1)^(-1) * y(1, 2)^(-1),
            x(1, 2) * z(2) * x(1, 2)^(-1) * z(2)^(-1) * z(1)^(-1) * y(1, 2),
        ],
        [
            z(1),
            z(1)^(-1),
        ...
        [
            ...
            x(1, 2) * zt(1) * x(1, 2)^(-1) * zt(1),
            x(1, 2) * zt(1) * x(1, 2)^(-1) * zt(1)^(-1) * yt(1, 2),
            x(1, 2) * zt(1) * x(1, 2)^(-1) * zt(1)^(-1) * yt(1, 2)^(-1),
            x(1, 2) * zt(1) * x(1, 2)^(-1) * zt(1)^(-1) * yt(1, 2) * zt(2)^(-1),
            x(1, 2) * zt(1) * x(1, 2)^(-1) * zt(1)^(-1) * yt(1, 2) * zt(2),
        ],
        [
            zt(2),
            zt(2)^(-1),
            ...
            zt(2) * yt(1, 2)^(-1) * zt(2),
            zt(2) * yt(1, 2)^(-1) * zt(2)^(-1) * yt(1, 2)^(-1)^(-1),
            zt(2) * yt(1, 2)^(-1) * zt(2)^(-1) * yt(1, 2)^(-1),
        ],
        [
            y(1, 2),
            y(1, 2)^(-1),
            ...
            y(1, 2) * zt(1) * y(1, 2)^(-1) * zt(1),
            y(1, 2) * zt(1) * y(1, 2)^(-1) * zt(1)^(-1) * z(2),
            y(1, 2) * zt(1) * y(1, 2)^(-1) * zt(1)^(-1) * z(2)^(-1),
            y(1, 2) * zt(1) * y(1, 2)^(-1) * zt(1)^(-1) * z(2) * x(2, 1)^(-1),
            y(1, 2) * zt(1) * y(1, 2)^(-1) * zt(1)^(-1) * z(2) * x(2, 1),
        ],
        [
            x(2, 1),
            x(2, 1)^(-1),
            ...
            x(2, 1) * z(2)^(-1) * x(2, 1)^(-1),
            x(2, 1) * z(2)^(-1) * x(2, 1),
            x(2, 1) * z(2)^(-1) * x(2, 1)^(-1) * z(2)^(-1)^(-1),
            x(2, 1) * z(2)^(-1) * x(2, 1)^(-1) * z(2)^(-1),
        ],
        [
            yt(1, 2),
            yt(1, 2)^(-1),
            ...
            yt(1, 2) * z(1) * yt(1, 2)^(-1) * z(1),
            yt(1, 2) * z(1) * yt(1, 2)^(-1) * z(1)^(-1) * zt(2),
            yt(1, 2) * z(1) * yt(1, 2)^(-1) * z(1)^(-1) * zt(2)^(-1),
            yt(1, 2) * z(1) * yt(1, 2)^(-1) * z(1)^(-1) * zt(2) * x(1, 2),
            yt(1, 2) * z(1) * yt(1, 2)^(-1) * z(1)^(-1) * zt(2) * x(1, 2)^(-1),
        ],
        [
            x(1, 2),
            x(1, 2)^(-1),
        ...
        [
            ...
            x(2, 1) * y(2, 1) * x(2, 1)^(-1) * y(2, 1),
            x(2, 1) * y(2, 1) * x(2, 1)^(-1) * y(2, 1)^(-1) * z(2)^(-1),
            x(2, 1) * y(2, 1) * x(2, 1)^(-1) * y(2, 1)^(-1) * z(2),
            x(2, 1) * y(2, 1) * x(2, 1)^(-1) * y(2, 1)^(-1) * z(2)^(-1) * z(2)^(-1),
            x(2, 1) * y(2, 1) * x(2, 1)^(-1) * y(2, 1)^(-1) * z(2)^(-1) * z(2),
        ],
        [
            x(2, 1),
            x(2, 1)^(-1),
            ...
            x(2, 1) * yt(2, 1) * x(2, 1)^(-1) * yt(2, 1),
            x(2, 1) * yt(2, 1) * x(2, 1)^(-1) * yt(2, 1)^(-1) * zt(1),
            x(2, 1) * yt(2, 1) * x(2, 1)^(-1) * yt(2, 1)^(-1) * zt(1)^(-1),
            x(2, 1) * yt(2, 1) * x(2, 1)^(-1) * yt(2, 1)^(-1) * zt(1) * zt(1),
            x(2, 1) * yt(2, 1) * x(2, 1)^(-1) * yt(2, 1)^(-1) * zt(1) * zt(1)^(-1),
        ],
        [
            x(2, 1),
            x(2, 1)^(-1),
            ...
            x(2, 1) * z(1) * x(2, 1)^(-1) * z(1),
            x(2, 1) * z(1) * x(2, 1)^(-1) * z(1)^(-1) * z(2)^(-1),
            x(2, 1) * z(1) * x(2, 1)^(-1) * z(1)^(-1) * z(2),
            x(2, 1) * z(1) * x(2, 1)^(-1) * z(1)^(-1) * z(2)^(-1) * y(2, 1)^(-1),
            x(2, 1) * z(1) * x(2, 1)^(-1) * z(1)^(-1) * z(2)^(-1) * y(2, 1),
        ],
        [
            z(2),
            z(2)^(-1),
        ...
        [
            ...
            x(2, 1) * zt(2) * x(2, 1)^(-1) * zt(2),
            x(2, 1) * zt(2) * x(2, 1)^(-1) * zt(2)^(-1) * yt(2, 1),
            x(2, 1) * zt(2) * x(2, 1)^(-1) * zt(2)^(-1) * yt(2, 1)^(-1),
            x(2, 1) * zt(2) * x(2, 1)^(-1) * zt(2)^(-1) * yt(2, 1) * zt(1)^(-1),
            x(2, 1) * zt(2) * x(2, 1)^(-1) * zt(2)^(-1) * yt(2, 1) * zt(1),
        ],
        [
            zt(1),
            zt(1)^(-1),
            ...
            zt(1) * yt(2, 1)^(-1) * zt(1),
            zt(1) * yt(2, 1)^(-1) * zt(1)^(-1) * yt(2, 1)^(-1)^(-1),
            zt(1) * yt(2, 1)^(-1) * zt(1)^(-1) * yt(2, 1)^(-1),
        ],
        [
            y(2, 1),
            y(2, 1)^(-1),
            ...
            y(2, 1) * zt(2) * y(2, 1)^(-1) * zt(2),
            y(2, 1) * zt(2) * y(2, 1)^(-1) * zt(2)^(-1) * z(1),
            y(2, 1) * zt(2) * y(2, 1)^(-1) * zt(2)^(-1) * z(1)^(-1),
            y(2, 1) * zt(2) * y(2, 1)^(-1) * zt(2)^(-1) * z(1) * x(1, 2)^(-1),
            y(2, 1) * zt(2) * y(2, 1)^(-1) * zt(2)^(-1) * z(1) * x(1, 2),
        ],
        [
            x(1, 2),
            x(1, 2)^(-1),
            ...
            x(1, 2) * z(1)^(-1) * x(1, 2)^(-1),
            x(1, 2) * z(1)^(-1) * x(1, 2),
            x(1, 2) * z(1)^(-1) * x(1, 2)^(-1) * z(1)^(-1)^(-1),
            x(1, 2) * z(1)^(-1) * x(1, 2)^(-1) * z(1)^(-1),
        ],
        [
            yt(2, 1),
            yt(2, 1)^(-1),
            ...
            yt(2, 1) * z(2) * yt(2, 1)^(-1) * z(2),
            yt(2, 1) * z(2) * yt(2, 1)^(-1) * z(2)^(-1) * zt(1),
            yt(2, 1) * z(2) * yt(2, 1)^(-1) * z(2)^(-1) * zt(1)^(-1),
            yt(2, 1) * z(2) * yt(2, 1)^(-1) * z(2)^(-1) * zt(1) * x(2, 1),
            yt(2, 1) * z(2) * yt(2, 1)^(-1) * z(2)^(-1) * zt(1) * x(2, 1)^(-1),
        ],
        [
            x(2, 1),
            x(2, 1)^(-1),
    ...
    # for el in test_support_jacobian
    #     testb = 0
    #     iter = 1
    #     for el1 in test_support_jacobian
    #         if el == el1
    #             iter = iter + 1
    #         end
    #     end
    ...
    # two the same matrices but not catched by unique!(). 
    # thats why support_jacobian and test_support_jacobian have different lengths
